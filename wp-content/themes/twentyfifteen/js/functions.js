...
$(".slidenumber1").fadeIn("400");
$(".slidenumber2").fadeIn("400");
$(".slidenumber3").fadeIn("400");
$(".slidenumber4").fadeIn("400");
...
(function($) {
	...
	var sliderlength = $(".my_slider").length;
	var start = 4;
	
	setInterval( function() { 
	$.when($(".my_slider").fadeOut("400")).then( function (){
		start++;
		if (start>sliderlength) {
			start = 1;
		}
		$(".slidenumber"+start).fadeIn("400");
		start++;
		if (start>sliderlength) {
			start = 1;
		}
