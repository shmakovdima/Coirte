...
class dsfaq{
    ...
    function dsfaq(){
        ...
        $this->wp_ds_faq_default_array['wp_ds_faq_ver']           = '133';
            ...
            if($book[0]['mode'] == "0"){
                if(is_array($quest)){
                    ...
                    foreach ($quest as $s) {
                        ...
                        $results .= '<div class=" post_reply_comments ask_quest"><h2 class="dsfaq_quest_title">'.__('Question:', 'wp-ds-faq').'</h2> <span class="dsfaq_quest" id="dsfaq_quest_'.$s['id'].'">'.$s['quest'].'</span></div>';
                        $results .= '<div class=" post_reply_comments answer"><h2 class="dsfaq_answer_title">'.__('Answer:', 'wp-ds-faq').'</h2>';
