...
For a live example of these settings in action, please view the source of [Optimizer's homepage](http://www.nextgengalleryoptimizer.com/) (a NextGEN 2.0 gallery page with AJAX pagination) in your browser.
...
Optimizer also includes an *enhanced* version of the fantastic [Fancybox](http://fancybox.net) lightbox script, and only loads it on gallery pages. The result? Gorgeous galleries *and* a speedy site.

Optimizer v2.0 now supports NextGEN 2.0, NextGEN Legacy and the NextCellent Gallery fork.

= NextGEN Gallery Optimizer Pro =

Upgrade to [Optimizer Pro](http://www.nextgengalleryoptimizer.com/purchase/) for the new [NextGEN Gallery Deactivator](http://www.nextgengalleryoptimizer.com/#nextgen-gallery-deactivator) feature.  
A whole new level of speed optimization that only loads NextGEN’s *code* on gallery pages.

Upgrade to [Optimizer Pro](http://www.nextgengalleryoptimizer.com/purchase/) for the new [Dynamic Fancybox Settings Interface](http://www.nextgengalleryoptimizer.com/#dynamic-fancybox-settings-interface).  
...
[http://www.nextgengalleryoptimizer.com/](http://www.nextgengalleryoptimizer.com/)  
[http://www.nextgengalleryoptimizer.com/documentation/](http://www.nextgengalleryoptimizer.com/documentation/)  
[http://www.nextgengalleryoptimizer.com/purchase/](http://www.nextgengalleryoptimizer.com/purchase/)  
...
1. Now optimizes the new NextGEN v2.0.xx codebase, and the new NextGEN Legacy fork called [NextCellent Gallery](http://wordpress.org/plugins/nextcellent-gallery-nextgen-legacy/).
...
5. [Optimizer Pro](http://www.nextgengalleryoptimizer.com/purchase/) is introduced, including the all new [NextGEN Gallery Deactivator](http://www.nextgengalleryoptimizer.com/#nextgen-gallery-deactivator) feature, and the [Dynamic Fancybox Settings Interface](http://www.nextgengalleryoptimizer.com/#dynamic-fancybox-settings-interface).

6. [Optimizer's website](http://www.nextgengalleryoptimizer.com/) is introduced.

Please view the [changelog](http://wordpress.org/plugins/nextgen-gallery-optimizer/changelog/) for the full list of improvements and additions.
...
Please see [http://www.nextgengalleryoptimizer.com/](http://www.nextgengalleryoptimizer.com/).
